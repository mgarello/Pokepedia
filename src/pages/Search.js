        ...
        <div className="container">
            <div className="row justify-content-center align-items-center">
                <div className="col-12 col-lg-6 main-content">
                    <div className="logo">
                        <img src={pokepediaLogo} />
                    </div>
                    <div className="search-bar text-center input-group">
                        <input type="text" placeholder="Search by Pokémon name, move, ability or item..." className="form-control input-fields input-group-text-left fs-5" />
